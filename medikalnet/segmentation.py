...
class pneumothorax():
    ...
    def get_model(self):
        ...
        self.model_path=get_file('efb0_pnmtrx_e200_dice_0.019_val_dice_0.182.h5','https://github.com/SamSepi0l59/medikalnet/releases/download/v0.0.1b/efb0_pnmtrx_e200_dice_0.019_val_dice_0.182.h5',cache_subdir='models')
